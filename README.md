# CIS298_FinalProject
First Commit (Calli Best) - Started with creating the admin login page
                     - Username: callibest
                     - Password: Maverick$12
                     - Then created main page to show recipes and be able to add them. 

Second Commit (Zach Warsaw) - Wanted to implement the Spoonacular API so added the API key to settings.py
...
Third Commit (Khalil Aun) - Enhanced the website's base design and interactivity:
